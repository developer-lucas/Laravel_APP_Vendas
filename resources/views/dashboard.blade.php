					...
					<div class="row">
						...
						<div class="col-lg-12 mb-4">
							...
							<div class="alert alert-info" role="alert">
								Diariamente às 18h você receberá um e-mail com o relatório das vendas realizadas no dia.
							</div>

							<!-- Illustrations -->
							<div class="card shadow mb-4">
								<div class="card-header py-3">
									<h6 class="m-0 font-weight-bold text-primary">API - Instruções de uso</h6>
								</div>
								<div class="card-body">
